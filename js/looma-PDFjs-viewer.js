...
/* VILLAGETECH SOLUTIONS - - LOOMA PROJECT
 * adaption of pdf.js for Looma
 * Shannon, Nolan, Nikhil, Skip
 * summer 2015, MAR 2020
 *
 *
 * changes: remove some buttons using CSS in looma-looma-PDFjs-viewer.css,
 * 			enable URL formatting including file=, page=, zoom=
 * 			CSS restyling to match Looma UI
 * 			multiple SELECTIONs and remember selections for annotation [not opereational yet]
 * 			add popup dialog on selections for (i) speech, (ii) dictionary lookup, and (iii) general Looma media file linking
 *
 */
...
var DEFAULT_URL = 'Math-1.pdf#page=9';
...
var DEFAULT_SCALE = 'page-width';  //Looma change
var UNKNOWN_SCALE = 0;
...
var DEFAULT_PREFERENCES = {
    ...
    enableWebGL: false,
    pdfBugEnabled: false,  // LOOMA change from  true to false
    disableRange: false,
    disableStream: false,
