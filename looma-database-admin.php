...
<body>
	...
	mongoCreateIndex($activities_collection, array('ch_id' => 1));
    //$activities_collection->createIndex(array('fn' => 1));
    mongoCreateIndex($activities_collection, array('fn' => 1));

    //$text_files_collection->createIndex(array('dn' => 1), array('unique' => True));
    mongoCreateUniqueIndex($text_files_collection, array('dn' => 1));
