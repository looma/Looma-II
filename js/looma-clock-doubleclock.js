...
window.onload = function() {  
    ...
    var canvas = document.getElementById("doubleClock");
    resizeCanvas();
    ...
    */
    ...
    function userInput() {
        ...
        if (userH == hoursPassed && userM == minutesPassed) {
            outputValue = "You are correct! The difference between the clocks is ";
        }
        
        else {
            outputValue = "That's not right. The correct answer is ";
        }
