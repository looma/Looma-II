...
/**************************************/
    ...
    echo "</span>";
        ...
        /*
        echo "<span id='language-div' class='chapter-filter'>
          <span class='drop-menu'>Language:<select id='language-drop-menu' class='chapter-input black-border' name='lang' form='search'>
