...
Filename: looma-play-edited-video.js
Description: videoplayer controls for looma-play-edited-video.php
        ...
        if(parseFloat(videoTimes[index]) <= baseVideo.currentTime) {  // check if it is time for the next insertion
            //if(videoCollections[index] == "activities") {
                ...
                $.post("looma-database-utilities.php",
                    {cmd: "openByID", collection: videoCollections[index], id: videoIds[index]},
                    function(result) {
                        ...
                        //*********  CHAPTER  ************//
                        else if (result.ft == "chapter") {
    
                            var pdfPath;
                            if(lang === 'en') { pdfPath = "../content/" + result.fp + result.fn;}
                            else {                           pdfPath = "../content/" + result.fp + result.nfn;}
...
window.onload = function () {
    ...
    else {              document.getElementById("title").innerHTML = "Edited Video"; }
