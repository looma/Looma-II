      ...
      northEast = L.latLng(28.1841, 83.8938);
      ...
      airport.bindPopup(airportPopup,{minWidth: "auto"}).openPopup();
      ...
      setiRiver.bindPopup(setiRiverPopUp,{minWidth: "auto"}).openPopup();
      ...
      devisFalls.bindPopup(desvisFallsPopUp,{minWidth: "auto"}).openPopup();
      ...
      internationalMountainMuseum.bindPopup(internationalMountainMuseumPopUp,{minWidth: "auto"}).openPopup();
      ...
      gurkhaMuseum.bindPopup(gurkhaMuseumPopUp,{minWidth: "auto"}).openPopup();
      ...
      batCave.bindPopup(batCavePopUp,{minWidth: "auto"}).openPopup();
      ...
      worldPeacePagoda.bindPopup(worldPeacePagodaPopUp,{minWidth: "auto"}).openPopup();
      ...
      gupteshworMahadevCave.bindPopup(gupteshworMahadevCavePopUp,{minWidth: "auto"}).openPopup();
      ...
      chachawheeFunPark.bindPopup(chachawheeFunParkPopUp,{minWidth: "auto"}).openPopup();
      ...
      talBarahiTemple.bindPopup(talBarahiTemplePopUp,{minWidth: "auto"}).openPopup();
      ...
      regionalMuseum.bindPopup(regionalMuseumPopUp,{minWidth: "auto"}).openPopup();//
      ...
      miteriPark.bindPopup(miteriParkPopUp,{minWidth: "auto"}).openPopup();
      ...
      bindhyabasiniTemple.bindPopup(bindhyabasiniTemplePopUp,{minWidth: "auto"}).openPopup();
      ...
      phewaLake.bindPopup(phewaLakePopUp,{minWidth: "auto"}).openPopup();
    }
