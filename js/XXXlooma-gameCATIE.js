...
***************************/
    ...
    function rightMatchingOutput(matchedNum)
    {
        ...
        //SIENNA CSS
        $(matched[0]).addClass("right");
        $(matched[1]).addClass("right");
        ...
        setTimeout(function()
        {
            for (i = 0; i < promptButtons.length; i++)
            {
                ...
                {
                    //SIENNA CSS
                    $(promptButtons[i]).addClass("invisible");
            ...
            for (i = 0; i < responseButtons.length; i++)
            {
                ...
                {
                    //SIENNA CSS
                    $(responseButtons[i]).addClass("invisible");
    ...
    function wrongMatchingOutput(promptNum, responseNum)
    {
        ...
        //SIENNA CSS
        $(wrongPrompt[0]).addClass("wrong");
        // wrongPrompt[0].style.color = "#f70426";
        var wrongResponse = document.getElementsByClassName('response ' + responseNum);
        //SIENNA CSS
        $(wrongResponse[0]).addClass("wrong");
        //wrongResponse[0].style.color = "#f70426";

        setTimeout(function()
        {
            //SIENNA CSS
            $(wrongPrompt[0]).removeClass("wrong");
            $(wrongResponse[0]).removeClass("wrong");
            if ($(wrongPrompt[0]).hasClass("hover")) $(wrongPrompt[0]).removeClass("hover");
            if ($(wrongPrompt[0]).hasClass("clicked")) $(wrongPrompt[0]).removeClass("clicked");
            if ($(wrongResponse[0]).hasClass("hover")) $(wrongResponse[0]).removeClass("hover");
            if ($(wrongResponse[0]).hasClass("clicked")) $(wrongResponse[0]).removeClass("clicked");
    ...
    function drag(ev)
    {
        // turn all other prompts black
        // var promptButtons = document.getElementsByClassName("prompt");
        // for (i = 0; i < promptButtons.length; i++)
        // {
        //     promptButtons[i].style.color = "black";
        // }
    ...
    function findResponse(event)
    {
        ...
        //remove old check function event listener (bound with previously selected prompt)
        ...
        // create new check function (bound with newly selected prompt)
        ...
        {
            //SIENNA CSS
            if ($(promptButtons[i]).hasClass("clicked")) {
                $(promptButtons[i]).removeClass("clicked");
            }
            // promptButtons[i].removeAttribute("style");
        }

        var clickedPrompt = document.getElementsByClassName('prompt ' + promptNum);
        //SIENNA CSS
        $(clickedPrompt[0]).addClass("clicked");
        // clickedPrompt[0].style.color = "blue";

        // add new check function event listener
        for (i = 0; i < responseButtons.length; i++)
        {
    ...
    function checkForMatch(promptNum, event)
    {
        ...
        var clickedPrompt = document.getElementsByClassName('prompt ' + promptNum);
        //SIENNA CSS
        $(clickedPrompt[0]).removeClass("clicked");
