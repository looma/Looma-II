...
function Hilitor2(id, tag)
{
  ...
  var colors = ["#ff6"]; // we deleted the other colors so all the words are highlighted in yellow instead of changing colors every letter
  var wordColor = [];
  var colorIdx = 0;
  var matchRegex = "";
  var openLeft = false;
  ...
  /*
      the accents section messes up the searching of vowels and consecutive vowels such as "oe," so we left it out for now
  */
  ...
  {
    /* 
       these characters (including the space character we added in between / and \ in line 72) do NOT separate the keywords entered into separate search terms.
       before adding this space to the list of characters that don't break up the keywords, searching for "the allies" would highlight all instances of "the" and "allies" 
    */
