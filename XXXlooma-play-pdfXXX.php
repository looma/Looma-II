...
<html lang="en" dir="ltr">
    ...
    <!--   *****************  LOOMA  *******************  -->
    <!-- ********************LOOMA modification  ********************** -->
    <link rel="stylesheet" href="css/XXXlooma-PDFjs-viewer.css"/>          <!--CSS from pdf.js project -->
    <link rel="stylesheet" href="css/XXXlooma-play-pdfXXX.css"/>              <!--CSS containing Looma modifications -->
      <!--   *****************  LOOMA  *******************  -->
    ...
    <script src="js/XXXlooma-PDFjs-viewerAPR.js"></script>
    <script src="js/XXXlooma-play-pdfXXX.js"></script>
    <!--   *****************  LOOMA  *******************  -->
