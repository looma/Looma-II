...
<div id="main-container-horizontal" class="scroll">
    ...
    if ($path == "/content/") {
        ...
        $tmp = $files['epaath2019'];
        unset($files['epaath2019']);
        $files = array('epaath2019' => $tmp) + $files;

        $tmp = $files['epaath2022'];
        unset($files['epaath2022']);
        $files = array('epaath2022' => $tmp) + $files;
    ...
    foreach ($files as $file => $dirInfo) {
        ...
        if ((    $file[0] !== "." &&
            ...
            //make a button that launches ePaath index.html -- virtual folder
            ...
            else if ($path . $file == "../content/epaath2022") {   //create a virtual folder for ePaath
                ...
                $ndn = "ई-पाठ";  //note should be using mongo folders collection to get dn and ndn
                $ft = "html";
                $thumb = "../content/epaath2022/thumbnail.png";
                makeActivityButton($ft, "../ePaath2022/", "index.html", $dn, $ndn, $thumb, "", "", "", "", "", "", "", "", null, null,null,null);
                echo "</td>";
                nextButton();
            }   // end IF ePaath2022
