...
Description: PDF viewer page for Looma 2
	uses pdf.js and looma-PDFjs-viewer.js from Mozilla
...
<div id="main-container-vertical" class="scroll">
    <div class="viewer">
       <!-- <div id="fullscreen"> -->
            ...
            // looma-viewer.html is viewer.html unchanged except for including looma-looma-PDFjs-viewer.css and looma-looma-PDFjs-viewer.js
