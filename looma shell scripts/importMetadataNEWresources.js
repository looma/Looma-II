// mongo terminal program "importMetadataNEWresources.js"
/*
...
//  dn,ndn,ch_id1,ch_id2,ch_id3,ch_id4,ch_id5,cl_lo,cl_hi,lang,key1,key2,key3,key4,fn,nfn,ft,lot
...
const FN = 14,   NFN = 15,   FT = 16, LOT = 17;
...
var input = 'data files/metadataNEWToImport.tsv';
...
lines.forEach( function(doc) {
    ...
    var name = fn ? fn : nfn;
    query = {'fn':  name, 'ft': ft };    // query to look for NEW resource files used FN and FT
                                         // for EXISTING resources it would be DN and FT
        ...
        if (!activities.hasNext()) { //not found
           ...
           // print (requestcount);
            ...
            if (activity) {
                ...
                if (fields[LOT]) activity['lot'] = fields[LOT];
