...
/*****************************/
  ...
  if ( isset($_REQUEST["ch_id"]) ) $ch_id = $_REQUEST['ch_id'];
  ...
  if ( isset($_REQUEST["cmd"]) ) {
    ...
    //accepted commands are "open", "openByName", "openByID","openText","save","copytext","updateByID","rename", "exists", "delete","deleteField",
      ...
      // "keywordAdd", "addChapterID","removeChapterID","editActivity","uploadFile", "download", "sendMail","getKeyVocabulary"
...
/////////////////////////////
          case "keywordAdd":
              ...
              echo "Add Keyword function is not implemented";
              return;
// end case "keywordAdd"
...
*/
    ...
    ///////////////////////////////////////////
        case "sendmail":
          ...
          ///////////////////////////////////////////
          // getKeyVocabulary ('ch_id', 'lang'},
          //             returns the ".keywords" file for a chapter
          //            .keywords files are generated by openAI and stored with chapter PDFs
          ///////////////////////////////////////////
