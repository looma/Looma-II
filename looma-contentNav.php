...
Date: 2016 6
Revision: Looma 2.1.0  [modified by Skip 2017 03]
  ...
  <div class="container-fluid">
    <div class="row navbar">
      ...
      <div class="row heading">
        <div class="col-sm-2">
          <img class="img-responsive logo" src="../Looma/images/logos/LoomaLogoTransparentTrimmed.png" alt="Looma Logo"</img>
        </div>
        <div class="col-sm-8">
...
<!--
 ...
 -->
  ...
  <!-- Load JS Last To Improve Load Time-->
